...
// *********************************************************************************
//  External function for putting a message on SupportedTestDataDomainsRequestChannelTowardsPlugin
//

func PutGetSupportedTestDataDomainsMessageOnChannelTowardsPlugin(supportedTestDataDomainsMessage *gRPC.SupportedTestDataDomainsRequest) {
